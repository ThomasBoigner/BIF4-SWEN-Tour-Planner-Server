...
public record Address(
    ...
    public Address {
        ...
        when(streetName, "street name").isNotNull().and().isNotEmpty().and().isNotBlank().thenAssign();
        when(streetNumber, "street number").isNotNull().and().isNotEmpty().and().isNotBlank().thenAssign();
    }
}
